...
void delta_x_final(const string& input_str){
...
fstream fin3;
fin3.open("/scratch8/ge37liw/workingspace/exp_s455/my_macros/twim_calibration/xal_vs_dt_params.csv", ios::in); 
string line3, word3;
...
char f_out_name[500];
sprintf(f_out_name,"delta_x_final_subrun_%s.root",input_str.c_str());
