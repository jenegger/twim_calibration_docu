...
//drift time histograms for section 0

TH1D* h1_drift_sec0[16];
for (Int_t i = 0; i < 16; i++){
sprintf(hist_name,"Section 0, Anode %i -> Drift Time",i);
h1_drift_sec0[i] = new TH1D(hist_name,hist_name,3250,0,32500);
h1_drift_sec0[i]->GetXaxis()->SetTitle("Drift Time");
h1_drift_sec0[i]->GetYaxis()->SetTitle("Counts");
h1_drift_sec0[i]->GetXaxis()->CenterTitle(true);
h1_drift_sec0[i]->GetYaxis()->CenterTitle(true);
h1_drift_sec0[i]->GetYaxis()->SetLabelSize(0.045);
h1_drift_sec0[i]->GetYaxis()->SetTitleSize(0.045);
}

//drift time histograms for section 1

TH1D* h1_drift_sec1[16];
for (Int_t i = 0; i < 16; i++){
sprintf(hist_name,"Section 1, Anode %i -> Drift Time",i);
h1_drift_sec1[i] = new TH1D(hist_name,hist_name,3250,0,32500);
h1_drift_sec1[i]->GetXaxis()->SetTitle("Drift Time");
h1_drift_sec1[i]->GetYaxis()->SetTitle("Counts");
h1_drift_sec1[i]->GetXaxis()->CenterTitle(true);
h1_drift_sec1[i]->GetYaxis()->CenterTitle(true);
h1_drift_sec1[i]->GetYaxis()->SetLabelSize(0.045);
h1_drift_sec1[i]->GetYaxis()->SetTitleSize(0.045);
}

//drift time histograms for section 2

TH1D* h1_drift_sec2[16];
for (Int_t i = 0; i < 16; i++){
sprintf(hist_name,"Section 2, Anode %i -> Drift Time",i);
h1_drift_sec2[i] = new TH1D(hist_name,hist_name,3250,0,32500);
h1_drift_sec2[i]->GetXaxis()->SetTitle("Drift Time");
h1_drift_sec2[i]->GetYaxis()->SetTitle("Counts");
h1_drift_sec2[i]->GetXaxis()->CenterTitle(true);
h1_drift_sec2[i]->GetYaxis()->CenterTitle(true);
h1_drift_sec2[i]->GetYaxis()->SetLabelSize(0.045);
h1_drift_sec2[i]->GetYaxis()->SetTitleSize(0.045);
}

// drift time histograms for section 3

TH1D* h1_drift_sec3[16];
for (Int_t i = 0; i < 16; i++){
sprintf(hist_name,"Section 3, Anode %i -> Drift Time",i);
h1_drift_sec3[i] = new TH1D(hist_name,hist_name,3250,0,32500);
h1_drift_sec3[i]->GetXaxis()->SetTitle("Drift Time");
h1_drift_sec3[i]->GetYaxis()->SetTitle("Counts");
h1_drift_sec3[i]->GetXaxis()->CenterTitle(true);
h1_drift_sec3[i]->GetYaxis()->CenterTitle(true);
h1_drift_sec3[i]->GetYaxis()->SetLabelSize(0.045);
h1_drift_sec3[i]->GetYaxis()->SetTitleSize(0.045);
}
//-------------------------------
	...
	if (entries_twim > 31){
		...
		if ((min_sec0 > 1) && (min_sec2 > 1) && (e_sum_sec_1 == 0) && (e_sum_sec_3 == 0)){
			...
			for (Int_t j = 0; j < 16; j++){
				h1_drift_sec0[j]->Fill(drift_sec_0_arr[j]);
				h1_drift_sec2[j]->Fill(drift_sec_2_arr[j]);
				}
			}
		...
		if ((min_sec0 > 1) && (min_sec3 > 1) && (e_sum_sec_1 == 0) && (e_sum_sec_2 == 0)){
			...
			for (Int_t j = 0; j < 16; j++){
				h1_drift_sec0[j]->Fill(drift_sec_0_arr[j]);
				h1_drift_sec3[j]->Fill(drift_sec_3_arr[j]);
				}
			}
		...
		if ((min_sec1 > 1) && (min_sec2 > 1) && (e_sum_sec_0 == 0) && (e_sum_sec_3 == 0)){
			...
			for (Int_t j = 0; j < 16; j++){
				h1_drift_sec1[j]->Fill(drift_sec_1_arr[j]);
				h1_drift_sec2[j]->Fill(drift_sec_2_arr[j]);
				}
			}
...
for (Int_t i = 0; i < 16; i++){
l->Add(h1_drift_sec0[i]);
l->Add(h1_drift_sec1[i]);
l->Add(h1_drift_sec2[i]);
l->Add(h1_drift_sec3[i]);
}
l->Write("histlist", TObject::kSingleKey);
////Canvases for the drift times of the various sections
//TCanvas sec0_c("sec0_c","Section0: Drift times for Anodes");
//sec0_c.Divide(4,4);
//for (Int_t i = 0; i < 16; i++){
//	sec0_c.cd(i+1);
//	h1_drift_sec0[i]->Draw();
//	}
//sec0_c.Write();
//TCanvas sec1_c("sec1_c","Section1: Drift times for Anodes");
//sec1_c.Divide(4,4);
//for (Int_t i = 0; i < 16; i++){
//	sec1_c.cd(i+1);
//	h1_drift_sec1[i]->Draw();
//	}
//sec1_c.Write();
//TCanvas sec2_c("sec2_c","Section2: Drift times for Anodes");
//sec2_c.Divide(4,4);
//for (Int_t i = 0; i < 16; i++){
//	sec2_c.cd(i+1);
//	h1_drift_sec2[i]->Draw();
//	}
//sec2_c.Write();
//TCanvas sec3_c("sec3_c","Section3: Drift times for Anodes");
//sec3_c.Divide(4,4);
//for (Int_t i = 0; i < 16; i++){
//	sec3_c.cd(i+1);
//	h1_drift_sec3[i]->Draw();
//	}
//sec3_c.Write();
}
